...
CREATE TABLE `players` (
  ...
  KEY `team` (`team`),
  CONSTRAINT `playerPosition` FOREIGN KEY (`playerPosition`) REFERENCES `positions` (`positionID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `team` FOREIGN KEY (`team`) REFERENCES `teams` (`teamID`) ON DELETE CASCADE ON UPDATE CASCADE
